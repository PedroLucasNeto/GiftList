  ...
  return (
    <div className="bg-lightnude py-12">
      <div className="container mx-auto">
        <h2 className="text-5xl text-center mb-8 font-hurricane">
          Nossa História
        </h2>
        <div className="flex flex-col justify-center items-center ">
          ...
          <div className="text-center mt-8">
            ...
            molestias odio illum expedita quas incidunt, dolore, enim fugiat
            voluptatum fuga consequatur laboriosam quod saepe tempore sint
            nostrum quisquam cum?
          </div>
        </div>
      </div>
    </div>
