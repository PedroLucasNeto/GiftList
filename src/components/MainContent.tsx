        ...
        <div className='lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8'>
          <div className='lg:pr-4'>
            <div className='max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg'>
              ...
              <ul role='list' className='mt-8 space-y-8 text-gray-600'>
                ...
                <li className='flex gap-x-3'>
                  ...
                  <span>
                    ...
                    Nossas palestras motivacionais são projetadas para inspirar
                    e engajar equipes. Com temas personalizados que atendem às
                    necessidades específicas de cada organização, nossas
                    palestras têm um impacto profundo na motivação e no
              ...
              <p className='mt-6'>
                Hoje, a CGRH continua comprometida com sua missão original,
                adaptando-se às mudanças e desafios do mundo empresarial. Nossa
                história é uma história de parceria, crescimento e sucesso
                compartilhado com nossos clientes. Estamos ansiosos para
                continuar a apoiar sua organização em sua jornada rumo à
                excelência.
              </p>
            </div>
          </div>
