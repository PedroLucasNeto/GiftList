      ...
      <div className='bg-gray-100'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          ...
          <div className='mx-auto max-w-2xl lg:max-w-none '>
            <div className='mt-4 space-y-12 lg:grid lg:grid-cols-3 lg:gap-x-6 lg:space-y-0 gap-4'>
              {services.map((service) => (
                <div
                  key={service.name}
                  className='group relative pb-6 bg-white p-2 '
                >
                  <div
                  ...
                  <h3 className='mt-2 text-sm text-blue-900  '>
                    <a href={service.link}>
