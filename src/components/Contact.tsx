    ...
    <>
      <div>
        <div className='flex flex-wrap lg:flex-nowrap gap-4 bg-gray-100 border-t-gray-100 min-h-screen'>
          <div className='lg:w-7/12 mx-auto text-center lg:mx-0 lg:flex-auto lg:text-center bg-gray-200 p-8'>
            ...
            <div className='mt-10 flex items-center justify-center gap-x-6 lg:justify-center'>
              <Link
                to='/'
                className='text-sm font-semibold leading-6 text-darkblue hover:text-blue-900'
              >
              ...
              <a
                ...
                target='blank'
                className='rounded-md bg-green-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white'
              >
                WhatsApp
              </a>
            </div>
