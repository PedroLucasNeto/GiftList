...
const features = [
  ...
  },
  {
    ...
    description:
      "O nosso programa de formação de líderes visa desenvolver estrategicamente os talentos da sua empresa. Nosso programa de orientação de carreira alia ciência e técnica na busca do melhor desenvolvimento profissional para os colaboradores.",
    icon: StarIcon,
  },
  {
